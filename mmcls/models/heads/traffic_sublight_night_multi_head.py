...
class TrafficSubLightneightMultiClsHead(ClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(TrafficSubLightneightMultiClsHead, self).__init__(init_cfg=init_cfg, *args, **kwargs)
    ...
    def simple_test(self, x):
        ...
        if torch.onnx.is_in_onnx_export() or on_trace:
            return [color_pred, shape_pred, toward_pred]
    ...
    def train(self, mode=True):
        super(TrafficSubLightneightMultiClsHead, self).train(mode)
        self._freeze_head()
