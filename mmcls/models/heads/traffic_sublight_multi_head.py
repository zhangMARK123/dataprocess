...
class TrafficSubLightMultiClsHead(ClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(TrafficSubLightMultiClsHead, self).__init__(init_cfg=init_cfg, *args, **kwargs)
    ...
    def train(self, mode=True):
        super(TrafficSubLightMultiClsHead, self).train(mode)
        self._freeze_head()
