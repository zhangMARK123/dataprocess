...
class TrafficSubLightcomplexMultiClsHead(ClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(TrafficSubLightcomplexMultiClsHead, self).__init__(init_cfg=init_cfg, *args, **kwargs)
    ...
    def train(self, mode=True):
        super(TrafficSubLightcomplexMultiClsHead, self).train(mode)
        self._freeze_head()
