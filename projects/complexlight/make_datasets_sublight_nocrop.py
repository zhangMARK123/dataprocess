...
train_set_json_file = "/disk3/zbh/Datasets/2022_QA_icu30_train_complexlight0523_adddata.json"
...
#         continue
    ...
    ###增加训练集
    if data_card_id not  in["6253943016999107083c4fb3",
"62539a1b169991070856d3d9",
"625640d9d10aada93a7f559f",
"625fd46f922e59dc87c0a206",
"625fd9a8922e59dc87c45e42",
"625fedb7922e59dc87f6deca",
"6260dff2922e59dc874e5595",
"62654c456a3b738ef7313e90",
"62654d916a3b738ef734c0ca",
"62654f226a3b738ef738ba40",
"6207c1bbd3572380d596ab26",
"6207d426d3572380d596ea29",
"620a0077d3572380d57d7b1e",
"620a033ed3572380d58a10dd",
"620a153dd3572380d5b03348",
"62148823ecf096dc1b3b4d99",
"6219df488ec597d64c599cb9",
"622c5a80e7e4ab0e76740c5d",
"6231edd3625d0d7504b62dd5",
"623ed93d79e30de882dc89f0",
"6241b43e79e30de88213b1d2",
"6242722c79e30de882a64954",
"6242737e79e30de882a916a9",
"6242b18879e30de8828f85f5",
]:
        continue
            ...
            for object in sample_json["objects"]:
                ...
                if object["num_sub_lights"] != 0 and ("sub_lights" in object.keys()):
                    ...
                    for sub in object["sub_lights"]:
                        ...
                        ###将带倒计时的灯也考虑在内,有倒计时直接忽略。这部分删掉了只有倒计时的灯，不做识别
                    ...
                    if num_color == 1 or num_color == 0:    # 只有一个子灯，或者全部unknown，全部黑。有个问题，有没有可能子灯颜色全部标注unknown
                        ...
                        ##去除掉只有倒计时的灯
                        if object["num_sub_lights"]==3 and (num_black+num_color)!=3 and num_black==2:
                            object["lightboxcolor_head"] = False
                        ##若全黑，则颜色为黑色
                        ...
                        if subcolor==1 and len(object["sub_lights"])==3 and object["sub_lights"][0]["color"]==1:
                            # object["boxcolor"] = 0
                            object["lightboxcolor_head"] = False
                        if subcolor==0 and len(object["sub_lights"])==3 and object["sub_lights"][1]["color"]==1:
                            # object["boxcolor"] = 1
                            object["lightboxcolor_head"] = False
                    else:
                        object["lightboxcolor_head"] = False
