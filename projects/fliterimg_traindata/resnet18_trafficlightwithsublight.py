...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/disk3/zbh/Datasets/2022_Q1_icu30_complexlight_all_1.json',
        data_prefix='/disk3/zbh/Datasets/2022_Q1_icu30_crop/',
        pipeline=train_pipeline),
        
    val=dict(
        type=dataset_type,
        ann_file=dataset_root + "2022_Q1_icu30_test_complexlight.json",
...
resume_from = None
workflow = [('train', 1)]
work_dir = "./work_dirs/complexlight_img/sublightalldata1"
