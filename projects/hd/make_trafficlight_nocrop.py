...
data_root = "/disk5/jiachun/"
train_set_json_file ="/disk3/zbh/Datasets/2022_Q1_hd_train.json"
test_set_json_file ="/disk3/zbh/Datasets/2022_Q1_hd_test.json"
debug_set_json_file ="/disk3/zbh/Datasets/2022_Q1_hd_test_debug.json"

card_id_list = []
object_list = []
OBJECT_COUNT = 0
for data_card_id in os.listdir(data_root):
    # if data_card_id not in ['CN_TL_YellowSolid_H','CN_TL_YellowSolid']:
    #     continue
