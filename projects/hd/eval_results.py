...
def plotcrop(imgpath,labelpath,wpath):
    ...
    for obj in labels["objects"]:
        ...
        if obj["label_character_gt"] not in ['0','1']:
           obj["lightboxcolor_head"]=False
        if obj["label_toward_gt"]=='1':
            obj["lightboxcolor_head"]=False
...
def evalresult(labelpath,wpath):
    ...
    for result_output in labels["objects"]:
        ...
        if result_output["label_character_gt"] not in ['0','1'] :
            result_output["lightboxcolor_head"]=False
        if result_output["label_toward_gt"]=='1':
            result_output["lightboxcolor_head"]=False
...
labelpath="../../work_dirs/test_hd/1_result.json"
wpath="../../work_dirs/test_hd/1_result_eval.json"
evalresult(labelpath,wpath)


imgpath="/disk3/zbh/Datasets/2022_Q1_hd_crop/"
wimg="../../work_dirs/test_hd/test1/testcolor"
