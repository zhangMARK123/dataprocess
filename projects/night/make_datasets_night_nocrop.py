...
def analyze_target_list(target_list):
    ...
    return number_color_dict, number_shape_dict, number_toward_dict


data_root = "/disk3/zbh/Datasets/2022_Q1_cp/"
img_write_path="/disk3/zbh/Datasets/2022_Q1_night/"
train_set_json_file =data_root+ "../2022_Q1_icu30_allnight.json"
test_set_json_file =data_root+ "../2022_Q1_icu30_test_neight.json"
debug_set_json_file =data_root+ "../2022_Q1_icu30_test_neight_debug2.json"
...
for data_card_id in os.listdir(data_root):
    if data_card_id not in ['623afbcce53b5981786cd9a5', '623bfe78e53b598178361b5d','623c0904e53b59817842e565']:
        continue   
    # if data_card_id not in ['623c0904e53b59817842e565']:
    #     continue
            ...
            for object in sample_json["objects"]:
                ...
                if object["num_sub_lights"] != 0 and ("sub_lights" in object.keys()):
                    ...
                    for sub in object["sub_lights"]:
                        ...
                        if sub["color"] in [0, 1, 2,4]:
                            ...
                            if sub["shape"] == 0:
                                ...
                                subshape = 2
                            elif sub["shape"] == 2 or sub["shape"] == 3:                              
                                subshape=1
                            elif sub["shape"] == 5:     
                                subshape = 3
                            elif sub["shape"] == 7:     
                    ...
                    if num_color == 1 or num_color == 0:    # 只有一个子灯，或者全部unknown，全部黑。有个问题，有没有可能子灯颜色全部标注unknown
                        ...
                        if object["boxcolor"]==4:
                            object["boxcolor"]=3
                        if num_black==object["num_sub_lights"] or object["boxcolor"]==5:
                            object["boxcolor"] = 4
                    else:
                        object["lightboxcolor_head"] = False
                        object["lightboxshape_head"] = False
...
if True:
    ...
    # number_color_dict, number_shape_dict, number_toward_dict, number_character_dict = analyze_target_list(
    #     test_object_list)
    ...
    number_color_dict, number_shape_dict, number_toward_dict= analyze_target_list(
        train_object_list)
